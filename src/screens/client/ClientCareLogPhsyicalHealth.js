...
export default function ClientCareLogPhysicalHealth({ navigation, route }) {
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        >
          <Text style={{}} category="s1">
            What is client's physical health?
          </Text>
          <Text style={{ marginTop: 5 }} category="p2">
            Select the option that best reflect Client's physical health during
            your visit
          </Text>
        </View>
        <Divider />
        ...
        <Divider />
        <ListItem title="Weight Changed " accessoryLeft={checkBox} />
        <Divider />
        <ListItem title="Exercise" accessoryLeft={checkBox} />
        <Divider />
